  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Técnicas de análisis financiero
        p.mb-4 #[b Objetivo:] reconocer las técnicas de análisis financiero utilizadas en la organización a partir de la información financiera. 
